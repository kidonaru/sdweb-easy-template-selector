...
def on_ui_settings():
    ...
    shared.opts.add_option("easy_template_anima_space_after_comma", shared.OptionInfo(True, "anima: カンマ後にスペースを自動挿入する", section=("easy_template_selector", "Easy Template Selector")))
    shared.opts.add_option("easy_template_anima_remove_break", shared.OptionInfo(True, "anima: BREAK をカンマに置換する", section=("easy_template_selector", "Easy Template Selector")))
